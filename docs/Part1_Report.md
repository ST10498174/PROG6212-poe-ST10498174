...
The ERD is saved as `RaceDay_ERD.png`.
...
The complete endpoint plan is saved as `API_ENDPOINT_PLAN.md`.
...
- [ ] SQL script executed successfully in the student's SSMS environment.
- [ ] Twenty or more meaningful commits completed using the student's GitHub account.
- [ ] Successful green CI/CD screenshot added to README.
- [ ] Own-voice unlisted YouTube video recorded and linked in README.
